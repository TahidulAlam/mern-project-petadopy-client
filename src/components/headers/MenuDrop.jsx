...
const Dropdown = () => {
  ...
  return (
    <div className="relative block md:inline-block" ref={dropdownRef}>
      ...
      {showDropdown && (
        <div className="absolute right-0 mt-2 w-56 rounded-md shadow-lg bg-white transition-all duration-300 ease-in-out opacity-100 transform translate-y-0 z-50">
          <ul className="p-3 ">
