...
const AllDonation = () => {
  ...
  const totalPage = Math.ceil((allDCampData?.length || 0) / limit);
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axiosPrivate.delete(`/api/allDonations/${id}`).then((res) => {
  ...
  return (
    <div>
      <Container>
        {/* <DashBoardHeader content={<h1> All Donation campaign</h1>} /> */}
